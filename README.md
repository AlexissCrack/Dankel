...
apt-get update -y; apt-get upgrade -y; wget https://raw.githubusercontent.com/AlexissCrack/Dankel/master/instalscript.sh; chmod 777 instalscript.sh* && ./instalscript.sh*
